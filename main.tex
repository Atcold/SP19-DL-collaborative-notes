...
\input{lectures/08-a/theory.tex}
...
\input{lectures/12-a/sparse_coding.tex} 
\input{lectures/12-b/self-supervised-learning.tex}
\input{labs/12/theory}
\input{labs/13/theory}
\input{lectures/13-a/theory}
\input{lectures/13-b/13-b}
