...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{prdg/YC/02-a/theory.tex} %backprogation ch 5
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{arch/YC/05-lab/theory.tex} %components of cnn
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\part{Practical \& applications}\label{prt:prct}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\input{prct/YC/02-b/theory.tex} %backprogation in practice ch 6
\input{prct/YC/01-b/practice.tex} %manifold hypo ch 31
\input{prct/YC/01-lab/practice.tex} % tensor transform ch 32
