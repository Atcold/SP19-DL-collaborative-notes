...
\begin{figure}[ht]
    ...
    \includegraphics[width=0.9\linewidth]{figs/checkerboard0.png} 
    \end{subfigure}
    \begin{subfigure}{0.25\textwidth}
    \includegraphics[width=0.9\linewidth]{figs/checkerboard1.png}
    \end{subfigure}
    \begin{subfigure}{0.25\textwidth}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.75\textwidth]{figs/pointnet.jpg}
