...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.5\linewidth]{01_TreeLikeGraphs.PNG}
...
\begin{figure}
\centering
\includegraphics[width=0.5\linewidth]{02TreeGraphs2.PNG}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.5\linewidth]{03SemanticsPoincare.PNG}
\label{fig:relational_learning_gm}
...
\begin{figure}[htb!]
\centering
\includegraphics[width=0.5\linewidth]{04GeodesicsPoinCare.PNG}
\label{fig:relational_learning_gm}
