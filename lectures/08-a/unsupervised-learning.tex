...
% Authors: Yunhao Li, gz580, He Li (editor)
...
\begin{enumerate}
    ...
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[height=\textwidth]{lectures/08-a/energy-based-1.png}
        \caption{Principal Component Analysis}
        \label{fig:unsupervised-energy-1}
    \end{subfigure}
    \begin{subfigure}[b]{0.4\textwidth}
        \includegraphics[height=\textwidth]{lectures/08-a/energy-based-2.png}
