...
\begin{figure}[htb]
  \centering
    \includegraphics[width=\textwidth]{lectures/10-b/Images/1-Lorentz.png}
...
\begin{figure}[htb]
  \centering
    \includegraphics[width=\textwidth]{lectures/10-b/Images/2-Davidson.png}
...
\begin{figure}[htb]
  \centering
    \includegraphics[width=\textwidth]{lectures/10-b/Images/3-cog.png}
