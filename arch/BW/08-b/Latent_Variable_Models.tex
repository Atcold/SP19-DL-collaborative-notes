...
\begin{figure}[t]
\centering
\includegraphics[width=100mm]{figs/lvm_2.png}
...
As long as the energy of the incorrect answers is very large as compared to the right answer, the collapse problem won't be there. More specifically, if the energy of the “best wrong answer” is higher than the energy of the correct answer, then the model should work. For e.g. Square Square loss (Figure \cref{fig:sqloss})
\begin{figure}[ht]
\centering
\includegraphics[width=100mm,height=5cm]{figs/Square_Square.png}
