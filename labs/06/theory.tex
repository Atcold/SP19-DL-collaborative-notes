...
% Authors: Benjamin Ahlbrand, Xingyu Ding, Haoran Anthony Su, 3/12/19.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/seq_to_vec.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/learning_to_execute.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/seq_to_vec_to_seq.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/phrase_representation.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/seq_to_seq.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/bptt.png}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=200pt]{labs/06/images/bptt_formula.png}
